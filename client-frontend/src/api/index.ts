...
const menuItems: MenuItem[] = [
  ...
  },
  {
    id: 't3',
    name: 'Veggie Burrito',
    description: 'Rice, beans, lettuce, cheese, and salsa wrapped in a flour tortilla',
    price: 8.99,
...
export const fetchRestaurantById = (id: string): Promise<Restaurant | undefined> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export const placeOrder = (order: Omit<Order, 'id' | 'status' | 'createdAt'>): Promise<Order> => {
  return new Promise((resolve) => {
    setTimeout(() => {
